...
import { useUserinfoContext, useErrorContext, useInfoContext } from '../../../../helper/contextHooks';
...
const SummaryButtonsBelowSheet =
    ({
        ...
        const handleReopenSc = () => {
            if (user.hasRoleHr()) {
                removeScStatus(sc.id, SC_STATUS.CLOSED, setSc, setIsLoading, afterScFetched, info, error);
            }
        };
        ...
        return (
            ...
            <div className={classes.btnContainer}>
                <Button
                    className={isReopenScButtonVisible() ? classes.btnReopen : classes.hidden}
                    variant="contained"
                    color="secondary"
