...
describe('DownloadFile Component', () => {
  ...
  it('should match snapshot if file is downloaded', () => {
    let downloadedFile = {
      id: 21,
      employeeId: 504,
      fileId: 42,
    ...
    expect(resetDownloadedFileMock).toHaveBeenCalledTimes(1);
    expect(openMock).toHaveBeenCalledTimes(1);
    expect(openMock).toHaveBeenCalledWith(downloadedFile.url);
    expect(component).toMatchSnapshot();
  });
